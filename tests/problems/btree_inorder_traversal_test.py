...
from src.problems.btree_inorder_traversal_stack import Solution as SolutionStack
...
def test_solution_stack(root, expected):
    assert SolutionStack().inorderTraversal(root) == expected
